...
public class CustomBarChartRenderAll extends BarChartRenderer {

    private RectF mBarShadowRectBuffer = new RectF();

    private int mRadius;

    public CustomBarChartRenderAll(BarDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
