...
public class ChartFragmentToday extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_chart_today, container, false);
...
//        chart.animateY(1500);
        ...
        chart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ArrayList<BarEntry> newvals = populateData();
                AnimateDataSetChanged changer = new AnimateDataSetChanged(600, chart, values, newvals);
    ...
    private ArrayList<BarEntry> populateData() {
        ...
        for (int i = 0; i < 24; i++) {
            ...
            float val = (float) (Math.random()*multi);
            val = val <3?0:val;
            newvals.add(new BarEntry(i, val));
        }
